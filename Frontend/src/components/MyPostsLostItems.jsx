...
function MyPostsLostItems({ setCurrentPage, setSelectedItem }) {
  ...
  const getStatusColor = (aiStatus) => {
    switch(aiStatus) {
      case 'scanning': return 'text-blue-400';
      case 'match_found': return 'text-green-400';
      case 'no_matches': return 'text-gray-400';
      default: return 'text-gray-400';
    }
  };

  const getStatusText = (aiStatus) => {
    switch(aiStatus) {
      case 'scanning': return 'AI Scanning...';
      case 'match_found': return 'Match Found!';
      case 'no_matches': return 'No Matches Yet';
    ...
    <div className="space-y-4">
      {loading ? (
        <div className="text-center py-8 text-gray-400">
          ...
          <p className="text-sm">Loading your lost items...</p>
        </div>
        ...
        <div className="text-center py-8 text-gray-400">
          ...
          <p className="text-sm">No lost items reported yet</p>
        </div>
      )}
    </div>
  );
...
export default MyPostsLostItems;